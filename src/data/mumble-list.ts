...
export const GeneralPlayerMumbleList: { [key in enumMumbleType]: string[] } = {
...
export const GeneralEnemyMumbleList: MumbleList = {
	[enumMumbleType.General]: [
		'您的 DNA 對這世界沒有貢獻。',
		'是時候為你們的愚蠢付出代價了。',
...
export const MumbleDataList: { [key in enumCharacter]: MumbleList } = {
	[enumCharacter.Man]: {
		[enumMumbleType.General]: [
			...GeneralPlayerMumbleList[enumMumbleType.General],
		...
		[enumMumbleType.PlaceCard]: [
			...GeneralPlayerMumbleList[enumMumbleType.PlaceCard],
			'就這張吧，反正不影響績效。',
		],
		[enumMumbleType.EnemyPlaceCard]: [
			...GeneralPlayerMumbleList[enumMumbleType.EnemyPlaceCard],
			'媽耶！比主管查勤還可怕。',
		],
		[enumMumbleType.Hurt]: [
			...GeneralPlayerMumbleList[enumMumbleType.Hurt],
			'我的獎金啊啊啊...',
		],
		[enumMumbleType.Attack]: [
			...GeneralPlayerMumbleList[enumMumbleType.Attack],
			'打敗你比做月報還簡單啦！',
			'看我的曠職拳！',
		],
		[enumMumbleType.Lose]: [
			...GeneralPlayerMumbleList[enumMumbleType.Lose],
			'我的 KPI...達不到了...',
			'年終獎金...沒了...',
		],
	},
	...
	[enumCharacter.GkbotWorker]: {
		[enumMumbleType.General]: [
			...GeneralEnemyMumbleList[enumMumbleType.General],
			'逼逼...廁所打掃完成。開玩笑的。',
			'請問還有哪裡需要服務的？',
			'請輸入指令，但我不一定會照做。',
		],
		[enumMumbleType.PlaceCard]: [
			...GeneralEnemyMumbleList[enumMumbleType.PlaceCard],
			'搬運到這就行了嗎？',
		],
		[enumMumbleType.EnemyPlaceCard]: [
			...GeneralEnemyMumbleList[enumMumbleType.EnemyPlaceCard],
			'需要我搬運這個到指定地點嗎？',
		],
		[enumMumbleType.Hurt]: [
			...GeneralEnemyMumbleList[enumMumbleType.Hurt],
			'效能受損 10%！',
		],
		[enumMumbleType.Attack]: [
			...GeneralEnemyMumbleList[enumMumbleType.Attack],
			'人類害蟲就由我來清理！',
		],
		[enumMumbleType.Lose]: [
			...GeneralEnemyMumbleList[enumMumbleType.Lose],
			'沒關係，反正我是量產型的...',
		],
	},

...
import { enumCharacter, enumDialog, enumGameState } from '@/enums/game';
...
onMounted(() => {
    if (!enemy.value.Character) {
        // 若敵人是第一次初始化，就產生工作型 GKBot
